...
/// use mongo::{AsUpdate, Error, Update};
///
/// #[derive(Bson, Mongo)]
...
/// }
///
/// impl mongo::AsUpdate<UserUpdate> for User {
...
/// # use mongo::{Bson, Mongo};
/// use mongo::bson::Document;
/// use mongo::{AsFilter, AsUpdate, Comparator, Error, Update, Updates};
///
/// #[derive(Bson, Mongo)]
...
/// let client = mongo::Client::default();
///
