...
//!
//! The [`mongo::Client`][client] is asynchronous. For applications that need a synchronous
//! solution, the [`mongo::blocking`][blocking] API can be used.
//!
//! ## Making Collections
//!
...
//! #     email: Option<String>,
//! # }
//! # async fn doc() -> Result<(), mongo::Error> {
//! use mongo::{AsFilter, Comparator};
//!
...
//! # }
//! # async fn doc() -> Result<(), mongo::Error> {
//! use mongo::{AsFilter, Comparator, AsUpdate};
//!
//! let client = mongo::Client::new();
//!
//! let mut filter = User::filter();
...
#[cfg(feature = "mongo-derive")]
#[allow(unused_imports)]
#[macro_use]
extern crate mongo_derive;
#[cfg(feature = "mongo-derive")]
#[doc(hidden)]
pub use mongo_derive::*;
